...
public class EditorActivity extends AppCompatActivity {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        ...
                        mGender = DataEntry.GENDER_UNKNOWN; // Unknown
                    }
                }
            }
    ...
    private void insertPet(){
        ...
        values.put(DataEntry.COLUMN_PET_NAME, NameEditText);
        values.put(DataEntry.COLUMN_PET_BREED, BreedEditText);
        values.put(DataEntry.COLUMN_PET_GENDER, GenderSpinnerText);
        values.put(DataEntry.COLUMN_PET_WEIGHT, weightEditText);
